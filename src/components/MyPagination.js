...
export default function MyPagination(props) {
  ...
  React.useEffect(() => {
    var totalrecord = parseInt(props.totalrecord);
    ...
    if (totalrecord > 1) {
      if (totalrecord <= 9) {
        ...
        if (currentPage <= 5) pageArr = [1, 2, 3, 4, 5, 6, 7, 8, "", totalrecord];
        else if (totalrecord - currentPage <= 4)
          pageArr = [
            1,
            "",
            totalrecord - 7,
  ...
  }, [props.currentPage,props.totalrecord]);
